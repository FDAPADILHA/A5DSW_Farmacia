            ...
            <div class="content"><br><br><br><br><br><br><br>
                        <?php
                            if( !isset($_SESSION['cart']) || count( $_SESSION['cart'] ) == 0  ){
                                ...
                                foreach( $_SESSION['cart'] as $idmed => $quantidade ){
                                    
                                    $medicamento = MedicamentoDAO::getMedicamentosById($idmed);
                                    echo ' <tr>';
                                    echo '      <td>'.$medicamento->id.'</td>';
                                    echo '      <td>'.$medicamento->nome.'</td>';
                                    echo '      <td>'.$medicamento->formula.'</td>';
                                    echo '      <td>'.$quantidade.'</td>';
                                    echo '      <td>R$ '.$medicamento->preco.'</td>';
                                    
                                    $subtotal = $quantidade * $medicamento->preco;
                                    $total += $subtotal;
